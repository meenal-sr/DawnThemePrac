...
## Rule
NEVER create section, snippet, or JavaScript files directly from a Figma design.
...
## Enforcement
- Before writing to `sections/`, `snippets/`, or `js/sections/`: verify `features/[name]/brief.md` exists
